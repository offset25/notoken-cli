...
describe("knowledge graph: learnFromExecution", () => {
  let kg: typeof import("../../../src/nlp/knowledgeGraph.js");

  beforeEach(async () => {
    kg = await import("../../../src/nlp/knowledgeGraph.js");
  });
...
describe("concept expansion: expandQuery integration", () => {
  let ce: typeof import("../../../src/nlp/conceptExpansion.js");

  beforeEach(async () => {
    ce = await import("../../../src/nlp/conceptExpansion.js");
  });
...
describe("multi-classifier: concept expansion boost", () => {
  let mc: typeof import("../../../src/nlp/multiClassifier.js");

  beforeEach(async () => {
    mc = await import("../../../src/nlp/multiClassifier.js");
  });
...
describe("semantic similarity: paraphrase detection", () => {
  let ss: typeof import("../../../src/nlp/semanticSimilarity.js");

  beforeEach(async () => {
    ss = await import("../../../src/nlp/semanticSimilarity.js");
  });
...
describe("parseIntent: full pipeline integration", () => {
  let parseIntent: typeof import("../../../src/nlp/parseIntent.js").parseIntent;

  beforeEach(async () => {
    const mod = await import("../../../src/nlp/parseIntent.js");

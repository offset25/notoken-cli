...
describe("LLM response parsing", () => {
  ...
  it("formatLLMFallback formats a valid result", async () => {
    const { formatLLMFallback } = await import("../../../src/nlp/llmFallback.js");
    const result = {
      understood: true,
...
describe("LLM conversation context", () => {
  it("addLLMContext and getLLMContext work", async () => {
    const { addLLMContext, getLLMContext, clearLLMContext } = await import("../../../src/nlp/llmFallback.js");
    clearLLMContext();
...
describe("LLM backend detection", () => {
  ...
  it("isLLMConfigured returns boolean", async () => {
    const { isLLMConfigured } = await import("../../../src/nlp/llmFallback.js");
